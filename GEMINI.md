...
- **Anti-Sampling Rule**: Never report success or stability based on 'sampling' or 'random checking'. A full audit is the only acceptable baseline for confirmation. Reporting partial results as 'confirmed' is a violation of project integrity.
